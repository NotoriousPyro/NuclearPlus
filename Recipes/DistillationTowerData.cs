...
internal class DistillationTowerData : IModData
{
    public void RegisterData(ProtoRegistrator registrator)
    {
        ...
        registrator.RecipeProtoBuilder
            ...
            .AddInput(32, Ids.Products.SteamHi, "A")
            .SetDuration(60.Seconds())
            .AddOutput(6, NuclearPlusIds.Products.SpentFuelSolutionT3, "X")
            .AddOutput(91, NuclearPlusIds.Products.UranylNitrate, "Z")
        .BuildAndAdd();
        ...
        registrator.RecipeProtoBuilder
            ...
            .AddInput(6, NuclearPlusIds.Products.SpentFuelSolutionT3, "B")
            .AddInput(32, Ids.Products.SteamHi, "A")
            .SetDuration(60.Seconds())
            .AddOutput(1, NuclearPlusIds.Products.FissionProducts, "X")
            .AddOutput(5, NuclearPlusIds.Products.PlutoniumNitrate, "Z")
        .BuildAndAdd();
    }
}
